...
items: widget.items.map((item) {
                  ...
                  return InkWell(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          if (isSelected)
                            const Icon(FontAwesomeIcons.solidSquareCheck,color :Colors.blue)
                          else
                            const Icon(FontAwesomeIcons.squareCheck , color: Colors.blue,),
          ...
          value: widget.selectedvalue.isEmpty ? null : widget.selectedvalue.last,
          onChanged: (val){},
