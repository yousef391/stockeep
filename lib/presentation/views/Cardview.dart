            ...
            builder: (context, state) {
              return CustomScrollView(
                slivers: <Widget>[
                  ...
                  BlocProvider.of<AddproductCubit>(context).CardItems.isNotEmpty
                      ? SliverList.builder(
                      ...
                      ? SliverToBoxAdapter(
                          ...
                          ontap: () {
                            ...
                            BlocProvider.of<AddbciCubit>(context).postdata(BCi(
                                consomid: BlocProvider.of<AuthCubit>(context)
                                    .user!
                                    .id,
                            ...
                            BlocProvider.of<GetBcisCubit>(context).getdata(
                                ...
                                BlocProvider.of<AuthCubit>(context)
                                    ...
                                    .id
                                    .toString());
                                    BlocProvider.of<AddproductCubit>(context).voidcard();
                          },
